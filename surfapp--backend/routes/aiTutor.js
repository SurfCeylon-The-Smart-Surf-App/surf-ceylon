...
router.post('/gamification/check-badges', gamificationController.checkBadgeEligibility);
router.get('/gamification/leaderboard', gamificationController.getLeaderboard);
router.post('/gamification/calculate-points', gamificationController.calculatePoints);
