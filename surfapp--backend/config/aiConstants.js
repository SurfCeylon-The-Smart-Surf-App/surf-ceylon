...
module.exports = {
  // Model Server
  MODEL_SERVER_URL: process.env.MODEL_SERVER_URL || 'http://127.0.0.1:8000/predict',
  MODEL_SERVER_TIMEOUT: 30000, // 30 seconds
  
  // Pose Detection Server
  POSE_SERVER_URL: process.env.POSE_SERVER_URL || 'http://127.0.0.1:8001/detect',
  ...
  ALLOWED_GOALS: ['Endurance', 'Strength', 'Flexibility', 'Balance', 'Power', 'Stamina', 'Fat Loss'],
