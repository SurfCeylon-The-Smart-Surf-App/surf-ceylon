...
RANDOM_FOREST_MODEL = os.path.join(
    BASE_DIR, 'models', 'surf_forecast_model.joblib')

# Model 2: LSTM (for 7-day forecasts)
LSTM_MODEL = os.path.join(
    BASE_DIR, 'models', 'wave_forecast_multioutput_lstm.keras')
LSTM_SCALER_X = os.path.join(
    BASE_DIR, 'models', 'wave_forecast_scaler_X_multioutput.joblib')
LSTM_SCALER_Y = os.path.join(
    BASE_DIR, 'models', 'wave_forecast_scaler_y_multioutput.joblib')
LSTM_FEATURE_NAMES = os.path.join(
    BASE_DIR, 'models', 'wave_forecast_feature_names.joblib')
