...
const DEVICE_API_URL = 'http://10.121.69.168:3000'; // Your computer's IP address
...
// Function to get base URL (for riskAnalyzerAPI.js)
export const getRiskAnalyzerBaseUrl = () => getApiBaseUrl();
